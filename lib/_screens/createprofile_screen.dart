                  ...
                  MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      if(_isUpdate){
                        ...
                        if(schoolUserDetails[0]['first_name'].toString().toLowerCase() == _firstname.text.toLowerCase()
                            && schoolUserDetails[0]['last_name'].toString().toLowerCase() == _lastname.text.toLowerCase()
                            && schoolUserDetails[0]['course'].toString().toLowerCase() == coursedropdownValue.toString().toLowerCase()
                            && schoolUserDetails[0]['year_level'].toString() == yearDropdownValue.toString()
                        ){
                          // ignore: use_build_context_synchronously
                          ...
                          Navigator.pop(loadingContext);
                          // ignore: use_build_context_synchronously
                          showNotificationDialog(context, 'The details you entered didn\'t match our records', 'Student Not Found');
                        }
                      }
                    },
