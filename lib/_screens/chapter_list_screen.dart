...
class ChapterListScreen extends StatefulWidget {
  const ChapterListScreen({Key? key, this.callBack, this.chapters}) : super(key: key);
...
class _ChapterListScreenState extends State<ChapterListScreen> with TickerProviderStateMixin {
